...
public class RobotPIDConstants {
  ...
  public static final PIDConstants liftPID = new PIDConstants(45, 100, 0);
  ...
  public static final FeedForwardConstants liftFF =
      new FeedForwardConstants(0.78393, 3.3, 0, 0.81616); // kv 5.2952
  ...
  public static final PIDConstants climberLiftPID = new PIDConstants(0.6, 0, 0);
  public static final PIDConstants climberWinchAnglePID = new PIDConstants(0.25, 0, 0);
  public static final PIDConstants climberWinchPID = new PIDConstants(0.6, 0, 0);

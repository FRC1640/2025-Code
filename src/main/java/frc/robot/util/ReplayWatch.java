...
public class ReplayWatch {
  ...
  public static void main(String[] args) throws IOException, InterruptedException {
    // Find input log
    String inputLog = LogFileUtil.findReplayLog();
  ...
  private static void launchReplay(String inputLog) throws IOException, InterruptedException {
    ...
    var gradleBuilder =
        new ProcessBuilder(
            ...
            // Pass the init script:
            "--init-script",
            "injectSimProperty.gradle",

            // Omit tests/spotless if desired:
            "-x",
            "test",
            "-x",
            "spotlessApply",
    ...
    gradleBuilder.environment().put("AKIT_LOG_PATH", inputLog);

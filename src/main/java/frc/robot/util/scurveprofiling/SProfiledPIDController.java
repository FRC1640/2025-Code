...
public class SProfiledPIDController implements Sendable {
  ...
  private SCurveProfile.Constraints m_constraints;
  private SCurveProfile m_profile;
  private SCurveProfile.State m_goal = new SCurveProfile.State();
   ...
   */
  public void setGoal(SCurveProfile.State goal) {
    m_goal = goal;
  }
   ...
   * @return The goal.
   */
  public SCurveProfile.State getGoal() {
    return m_goal;
  }
   ...
   */
  public SCurveProfile.Constraints getConstraints() {
   ...
   */
  public SCurveProfile.State getSetpoint() {
    return m_setpoint;
  }
   ...
   * @return The controller's next output.
   */
  public double calculate(double measurement, SCurveProfile.State goal) {
    setGoal(goal);

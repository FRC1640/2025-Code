...
public class SparkConfiguration {
    ...
    public SparkConfiguration(int id, IdleMode idleMode, boolean inverted, int currentLimit, int encoderMeasurmentPeriod,
            int averageEncoderDepth, StatusFrames statusFrames) {
        this.id = id;

...
public class RobotPIDConstants {
  ...
  public static final PIDConstants liftProfiledPIDConstants =
      new PIDConstants(85, 0, 0.01); // new PIDConstants(27.25, 0.010569);
  public static final PIDConstants liftVelocityPID = new PIDConstants(0.5, 0, 0);
  public static final FeedForwardConstants liftFF =
      new FeedForwardConstants(0.62456, 8, 0.84372, 0.5477);

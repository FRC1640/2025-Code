...
public class RobotPIDConstants {
  ...
  public static final PIDConstants liftPID = new PIDConstants(45, 10, 0);
  public static final PIDConstants liftProfiledPIDConstants =
      new PIDConstants(35, 0, 0); // new PIDConstants(27.25, 0.010569);
  ...
  public static final PIDConstants climberLiftPID = new PIDConstants(0.5, 0, 0);

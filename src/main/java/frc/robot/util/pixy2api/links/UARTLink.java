 ...
 *
 * <p>FIRST Robotics WPI API UART/Serial Link to Pixy2
 *
 ...
 *     <p>Arduino UART link class, intended to be used with an Arduino with more than 1 UART, like
 *     the Arduino MEGA 2560.
 */
public class UARTLink implements Link {
  private static final int PIXY_UART_BAUDRATE = 19200;
